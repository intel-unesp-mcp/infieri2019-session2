...
!dec$ attributes C              :: sgemm_fortran
subroutine sgemm_fortran(r, a, b, arows, acols, bcols)
    implicit none
...
!dec$ attributes C              :: dgemm_fortran
subroutine dgemm_fortran(r, a, b, arows, acols, bcols)
    implicit none
    integer :: arows, acols, bcols
